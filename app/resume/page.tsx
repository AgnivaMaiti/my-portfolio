...
const resumeData = {
	personalInfo: {
		...
		summary:
			"Passionate Computer Science student with extensive experience in AI/ML research, app development, and technical leadership. Proven track record of contributing to research projects at prestigious institutions and developing innovative solutions for real-world problems.",
	},
	...
	projects: [
		{
			...
			description:
				"Image classification system designed to identify and label 6 different landscape categories in satellite images",
			technologies: ["Python", "Computer Vision", "Deep Learning"],
		},
		{
			name: "Geeti - AI Lyrics Generator",
			description:
				"AI-powered lyrics generator tailored to preferred genre, language, and song structure",
		...
		},
		{
			...
			description:
				"Web application designed to assist entrepreneurs in evaluating the viability of their startup ideas",
		...
		},
		{
			...
			description:
				"Flutter learning app with detailed documentation and rich examples for hands-on learning",
			technologies: ["Flutter", "Dart", "Mobile Development"],
		},
		{
			name: "Smart Air Purifier",
			description:
				"IoT-based air purification system with intelligent monitoring capabilities",
						...
						<div className="text-center mb-8">
							...
							<div className="flex flex-wrap justify-center gap-4 text-sm text-zinc-600 dark:text-zinc-400">
								...
								<Link
									...
									target="_blank"
									className="flex items-center gap-2 hover:text-zinc-800 dark:text-zinc-200"
								>
									...
									<div className="mt-3">
										...
										<div className="flex flex-wrap gap-2">
											{edu.relevant.map((course, i) => (
												<span
													key={i}
													className="bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-2 py-1 rounded-md text-xs"
												>
													{course}
												</span>
											))}
							...
							<div key={index} className="mb-8 last:mb-0">
								...
								<ul className="space-y-2">
									{exp.description.map((item, i) => (
										<li
											key={i}
											className="text-zinc-700 dark:text-zinc-300 text-sm flex items-start"
										>
					...
					<div className="p-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							{Object.entries(resumeData.skills).map(([category, skills]) => (
								<div key={category}>
									<h4 className="text-lg font-semibold text-zinc-800 dark:text-zinc-200 mb-3">
										{category}
									</h4>
									<div className="flex flex-wrap gap-2">
										{skills.map((skill, i) => (
											<span
												key={i}
												className="bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 px-3 py-1 rounded-md text-sm"
											>
												{skill}
											</span>
										))}
