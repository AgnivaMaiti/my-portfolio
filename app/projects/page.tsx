...
export default async function ProjectsPage() {
	...
	console.log(
		"Available projects:",
		allProjects.map((p: Project) => ({ slug: p.slug, published: p.published })),
	);
	...
	const featured =
		publishedProjects.find(
			(project: Project) => project.slug === "Murmuration",
		) || publishedProjects[0];

	const top2 =
		publishedProjects.find((project: Project) => project.slug === "Geeti") ||
		publishedProjects.find(
			(project: Project) => project.slug === "checklist",
		) ||
		publishedProjects.find(
			(project: Project) => project.slug !== featured?.slug,
		) ||
		publishedProjects[1] ||
		featured;
	...
	const top3 =
		publishedProjects.find(
			(project: Project) => project.slug === "Startup-Validator",
		) ||
		publishedProjects.find(
			(project: Project) => project.slug === "Resume-Analyzer",
		) ||
		publishedProjects.find(
			(project: Project) =>
